...
class Bootstrap extends EngineBootstrap
{
    ...
    public function afterEngine()
    {
        ...
        $this->getEventsManager()->attach('dispatch', $di->get('core')->xdomain());
        $this->getEventsManager()->attach('dispatch', $di->get('core')->translate());
        $this->getEventsManager()->attach('dispatch', $di->get('core')->request());
        $this->getEventsManager()->attach('dispatch', $di->get('core')->response());
        $this->getEventsManager()->attach('dispatch', $di->get('core')->fractalinclude());

            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-sm-8">
                        ...
                        {{ content() }}
                            <label class="col-sm-3 control-label">{{ 'form.name'|i18n }}</label>
                            <div class="col-sm-9">
                                <input
                                    type="text"
                                    class="form-control"
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">{{ 'form.email'|i18n }}</label>
                            <div class="col-sm-9">
                                {% if formData['email'] is defined %}{{ formData['email'] }}{% endif %}
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">{{ 'form.password'|i18n }}</label>
                            <div class="col-sm-9">
                                ********
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">{{ 'form.status'|i18n }}</label>
                            <div class="col-sm-9">
                                <select
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">{{ 'form.role'|i18n }}</label>
                            <div class="col-sm-9">
                                <select
                                    class="cs-select cs-skin-slide"
                                    data-init-plugin="cs-select"

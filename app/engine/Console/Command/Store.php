 ...
 *
 * @CommandName(['store'])
 * @CommandDescription('Mapping category and import product from haravan to five.')
 */
class Store extends AbstractCommand implements CommandInterface
{
    /**
     * Test action.
     *
     * @return void
     */
    public function syncAction($param1 = null, $param2 = null)
    {

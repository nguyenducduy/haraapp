...
class UrlImageable extends Behavior implements BehaviorInterface
{
    /**
     * External image path
     * @var string
    ...
    */
    ...
    public function __construct($options = null)
    {
        ...
        $this->filesystem = $di->get('filefive');
    ...
    // DI file service uses here, you can do it otherwise
    protected function setUrlPath(array $options)
    {
        if (!isset($options['urlPath']) || !is_string($options['urlPath'])) {
            throw new Exception("The option 'urlPath' is required and it must be string.");
        }

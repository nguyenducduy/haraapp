...
<?php echo $this->partial('Layout/Profiler/window', array('name' => 'config', 'title' => 'Phalcon Eye Config', 'content' => $htmlConfig)); ?>
<?php echo $this->partial('Layout/Profiler/window', array('name' => 'router', 'title' => 'Router', 'content' => $htmlRouter)); ?>
<?php echo $this->partial('Layout/Profiler/window', array('name' => 'memory', 'title' => 'Memory', 'content' => $htmlMemory)); ?>
<?php echo $this->partial('Layout/Profiler/window', array('name' => 'time', 'title' => 'Time', 'content' => $htmlTime)); ?>
<?php echo $this->partial('Layout/Profiler/window', array('name' => 'files', 'title' => 'Files', 'content' => $htmlFiles)); ?>
<?php echo $this->partial('Layout/Profiler/window', array('name' => 'sql', 'title' => 'SQL', 'content' => $htmlSql)); ?>
<?php echo $this->partial('Layout/Profiler/window', array('name' => 'errors', 'title' => 'Errors', 'content' => $htmlErrors)); ?>

            ...
            <div class="p-l-50 m-l-20 p-r-50 m-r-20 p-t-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
              ...
              <form id="form-login" class="p-t-15" role="form" action="" method="post">
                ...
                <div class="form-group form-group-default">
                  ...
                  <div class="controls">
                    <input type="text" name="fname" placeholder="" class="form-control" value="<?php echo $formData['fname']; ?>" autofocus required>
                  </div>
                </div>
                <!-- END Form Control-->
                <!-- START Form Control-->
                ...
                <div class="row">
                  <div class="col-md-6 no-padding">
                    <div class="checkbox ">
                        <input type="checkbox" name="fcookie" id="rememberMe" value="remember-me" <?php if ($formData['fcookie'] == true) { ?>checked<?php } ?>>
